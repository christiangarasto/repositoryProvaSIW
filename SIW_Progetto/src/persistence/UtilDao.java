...
public class UtilDao {
	...
	public void dropDatabase() {
		...
		try {
			String delete = "drop SEQUENCE if EXISTS sequenza_id;" + "drop table if exists ticket;"
					+ "drop table if exists evento;" + "drop table if exists luogo;" + "drop table if exists utente;";
