...
public class MainJDBC {
	...
	public static void main(String args[]) {
		...
		EventoDao eventoDao = factory.getEventoDAO();		
			Evento rapinaDay = new Evento("Rapina a mano armata","Vi svaligiamo il portafogli", "Culturale", new java.sql.Date(2001,10,02), new java.sql.Time(20,30,00), woodstock);
			...
			Evento capodanno = new Evento("Capodanno 2018 Roma", "Festeggiamo il nuovo anno", "Culturale", new java.sql.Date(2017,12,31), new java.sql.Time(23,00,00), colosseo);
		//CREATE
